...
SENSORS_ARRAY = [
    ...
    Sensor(10105, "BatteryLowVoltage",               0.1,     "V",      Platform.SENSOR,               SensorDeviceClass.VOLTAGE,         True,    None,                        None,                    None,  None,  None),
    ...
    Sensor(15213, "ErrorMessage",                    None,    None,     Platform.SENSOR,               None,                              True,    "mdi:alert-circle-outline",  None,                    None,  None,  None),
    Sensor(15214, "WarningMessage",                  None,    None,     Platform.SENSOR,               None,                              True,    "mdi:alert-outline",         None,                    None,  None,  None),
    ...
    Sensor(20009, "InverterBatteryVoltageC",         None,    "V",      Platform.SENSOR,               SensorDeviceClass.VOLTAGE,         False,   None,                        None,                    None,  None,  None),
    Sensor(20010, "InverterVoltageC",                None,    "V",      Platform.SENSOR,               SensorDeviceClass.VOLTAGE,         False,   None,                        None,                    None,  None,  None),
    Sensor(20011, "GridVoltageC",                    None,    "V",      Platform.SENSOR,               SensorDeviceClass.VOLTAGE,         False,   None,                        None,                    None,  None,  None),
    Sensor(20012, "BusVoltageC",                     None,    "V",      Platform.SENSOR,               SensorDeviceClass.VOLTAGE,         False,   None,                        None,                    None,  None,  None),
    Sensor(20013, "ControlCurrentC",                 None,    "A",      Platform.SENSOR,               SensorDeviceClass.CURRENT,         False,   "mdi:current-ac",            None,                    None,  None,  None),
    ...
    Sensor(20113, "InverterMaxDischargerCurrent",    0.1,     "A",      Platform.SENSOR,               SensorDeviceClass.CURRENT,         True,    "mdi:current-ac",            None,                    None,  None,  None),
